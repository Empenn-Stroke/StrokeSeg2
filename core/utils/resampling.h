...
#ifndef CORE_RESAMPLING_H
#define CORE_RESAMPLING_H
...
class Resampling {
  ...
  private:
     ...
     */
    float vote_nearest_1d(const Eigen::Tensor<float, 4, Eigen::RowMajor> &t, int c, int i, int j,
                          float pos, int axis) const;
};

#endif // CORE_RESAMPLING_H
