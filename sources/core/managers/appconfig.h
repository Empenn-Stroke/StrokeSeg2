 ...
 *
 * This structure encapsulates the configuration settings for the application, utilizing a reference to the singleton instance of the ConfigManager.
 */
struct AppConfig
{
 ...
 *
 * This function reads the application configuration settings from the specified INI file and returns them in an AppConfig structure.
 *
 ...
 *
 * This function writes the application configuration settings from the provided AppConfig structure to the specified INI file.
 *
