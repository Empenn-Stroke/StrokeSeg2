...
struct PreprocessedVolume 
{
     ...
     */
    Eigen::Vector3i originalShape;

    /**
     * @brief Path to the original image (before any preprocessing)
     */
    ...
    */
    ...
    void saveMetadata(const QString &path) {
        ...
        // paths
        obj["original_path"] = this->originalPath;
        obj["trsf_path"] = this->trsfPath;
        ...
        QJsonArray shape;
        shape.append(this->originalShape.x());
        shape.append(this->originalShape.y());
        shape.append(this->originalShape.z());
    ...
    bool loadMetadata(const QString &path) {
        ...
        // paths
        this->originalPath = obj["original_path"].toString();
        this->trsfPath = obj["trsf_path"].toString();
